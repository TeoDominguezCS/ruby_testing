...
describe BinaryGame do
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        valid_input = 3
        result = game_input.verify_input(minimum, maximum, valid_input)
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        maximum = game_input.instance_variable_get(:@maximum)
        invalid_input = 20
        result = game_input.verify_input(minimum, maximum, invalid_input)
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      subject(:game_input) {described_class.new(100,600)}
      it 'returns 9' do
        max = game_input.maximum_guesses
        expect(max).to eq(9)
      end
    end
  end
  ...
  describe '#display_turn_order' do
    ...
    it 'increases guess_count by one' do
      expect{game_turn.display_turn_order(binary_search_turn).to change(gameturn.instance_variable_get(@guess_count)).by(1)}
    end
